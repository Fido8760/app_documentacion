<div class="container contenedor">
    ...
    <div class="card formulario">
        ...
        <div class="card-body formulario__body">
            <h4 class="card-title formulario__body--titulo">agrega los archivos en PDF, del Remolque asignado </h4>

            <div class="formulario__body--alertas"><?php include_once __DIR__ . '/../templates/alertas.php' ?></div>


            <form action="/acuses/crearCaja" method="POST" enctype="multipart/form-data">

                <?php include_once __DIR__ . '/formulario-caja.php' ?>


                <div class="d-grid gap-2 col-6 mx-auto formulario__footer">
                    <input type="submit" class="btn btn-primary formulario__footer--btn-registrar" value="Registrar Acuses del Remolque"></input>
                </div>
            </form>
        </div>
    </div>
