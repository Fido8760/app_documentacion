...
<div class="container contenedor">
    ...
    <div class="card formulario">
        <div class="card-header d-flex justify-content-between formulario__header">
            ...
            <a href="/usuarios" class="btn btn-info formulario__header--btn-volver">Volver</a>
        </div>
        <div class="card-body formulario__body">
            ...
            <form action="/usuarios/crear-usuario" method="POST">

                <?php include_once __DIR__ . '/formulario.php' ?>


                <div class="d-grid gap-2 col-6 mx-auto formulario__footer">
                    <input type="submit" class="btn btn-primary formulario__footer--btn-registrar" value="Registrar Usuario"></input>
                </div>
            </form>
        </div>
    </div>
