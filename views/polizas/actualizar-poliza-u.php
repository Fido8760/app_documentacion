<div class="container contenedor">
    ...
    <div class="card formulario">
        <div class="card-header d-flex justify-content-between formulario__header">
            <h2 class="display-5 formulario__header--titulo"><?php echo $titulo . ' ' . $poliza_unidad->unidad->no_unidad; ?></h2>
        ...
        <div class="card-body formulario__body">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <?php include_once __DIR__ . '/formulario-u.php' ?>


                <div class="d-grid gap-2 col-6 mx-auto formulario__footer">
                    <input type="submit" class="btn btn-primary formulario__footer--btn-registrar" value="Actualizar Póliza"></input>
                </div>
            </form>
        </div>
    </div>
