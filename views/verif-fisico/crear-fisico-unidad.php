<div class="container contenedor">
    ...
    <div class="card formulario">
        ...
        <div class="card-body formulario__body">
            ...
            <form action="/verif-fisico/crearUnidad" method="POST" enctype="multipart/form-data">

                <?php include_once __DIR__ . '/formulario-unidad.php' ?>


                <div class="d-grid gap-2 col-6 mx-auto formulario__footer">
                    <input type="submit" class="btn btn-primary formulario__footer--btn-registrar" value="Registrar Físico-Mecánica de Unidad"></input>
                </div>
            </form>
        </div>
    </div>
